...
/**
 * @vue/test-utils v2.0.3
 * (c) 2022 Lachlan Miller
 * Released under the MIT License
 */

import * as Vue from 'vue';
import { transformVNodeArgs, Transition, BaseTransition, TransitionGroup, Teleport, defineComponent, h, nextTick, setDevtoolsHook, shallowReactive, reactive, isRef, createApp, computed } from 'vue';
...
function mount(inputComponent, options) {
    ...
    var Parent = defineComponent(__assign({ name: 'VTU_ROOT', render: function () {
            return h(component, __assign(__assign({}, props), refs), slots);
        } }, options === null || options === void 0 ? void 0 : options.rootComponentOptions));
...
export { BaseWrapper, DOMWrapper, RouterLinkStub, VueWrapper, config, createWrapperError, disableAutoUnmount, enableAutoUnmount, flushPromises, mount, shallowMount };
